...
class General
{
    ...
    function __construct()
    {
        ...
        add_filter( 'wpcf7_additional_settings', 'custom_additional_settings' );
        function custom_additional_settings( $additional_settings ) {
            $additional_settings .= "on_sent_ok: \"showModal('thank-you-modal');\"\n";
            $additional_settings .= "on_submit: \"showModal('thank-you-modal');\"\n";
